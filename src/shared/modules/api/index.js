...
export const addEmail = ({ id = '123', email }) => post(`/users/${id}/email`, { id, email })
export const addMobile = ({ id = '123', mobile }) => post(`/users/${id}/mobile`, { id, mobile })
export const loadUser = (id) => get(`/users/${id}`)
export const updateUser = ({ id, ...rest }) => post(`/users/${id}`, { id, ...rest })
export const updatePassword = ({ id, password }) => post(`/users/${id}/password`, password)
